                ...
                if (typeof selector === 'object') {
                    ...
                    for (var i = 0; i < selector.length; i++) {
                        var name = selector[i].name,
                            ...
                            fun = selector[i].fun,
                            parameters = selector[i].parameters,
    ...
    var iMethods = {
        ...
        closeContextMenu: function(option, trigger, menu, e) {
            ...
            if(typeof option === "undefined" || option === null){
            	...
            	if(typeof option.onClose === "undefined" || option.onClose === null){
            		;
            	} else {
        ...
        createMenuList: function(trgr, selector, option) {
            ...
            randomNum = ++menuCount;
            randomNum = "_" + option.prefix + "_" + randomNum;
